...
class Secur{
	...
	public static function name($saleter){
		if(preg_match("#^[a-zA-Z-]{2,35}$#u", $saleter))
			return $saleter;
		else
			return false;
	}
	public static function birthday($saleter){
		if(preg_match("#[0-9]{2}/[0-9]{2}/[0-9]{4}$#u", $saleter))
			return $saleter;
		else
			return false;
	}
	public static function codePostal($saleter){
		if(preg_match("#[0-9]{5}$#u", $saleter))
			return $saleter;
		else
			return false;
	}
