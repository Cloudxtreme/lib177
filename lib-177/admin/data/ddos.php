...
$icq . '<hr>(c)StreamHost antiddos module'; // Ban message
...
header('WWW-Authenticate: Basic realm="Entrez le mot de pass\': ' . $ddospass .
' | Login: ' . $ddosuser . '"');
...
$_SERVER['HTTP_HOST'] .
' at port 80 with <a href="http://streamhost.biz/">ddos protect</a></i></small>');
}
break;
default:
break;
