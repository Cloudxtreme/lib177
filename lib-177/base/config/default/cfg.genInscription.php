...
return $cfg['genInscription'] = array(
    'save' => array(
        ...
        /**/'Password' => array(
					...
					'verif' => 'strlen($_POST[\'Password\']) < 31 && strlen($_POST[\'Password\']) > 1'
			),/**/
        /**/'Password Confirmation' => array(
					...
					'verif' => '$_POST[\'Password\'] == $_POST[\'PassConfirm\']'
			),/**/
        /**/'First name' => array(
